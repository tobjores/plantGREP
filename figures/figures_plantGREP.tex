...
\begin{document}
	...
	\ifmain
		...
		\begin{fig}
			...
			\caption{%
				...
				\subfigtwo{E}{F} Correlation of \parensubfig{E} and fold-change in \parensubfig{F} enhancer strength between sequences tested in the forward and reverse orientation across the indicated Plant STARR-seq conditions. The dashed and dotted lines in \parensubfig {F} represent a 1.5-fold and 2-fold difference, respectively. \nextentry
				...
				\subfig{I} Correlation between enhancer strength and gene expression in various tissues (dots) of the indicated species. ACR sequences were linked to the closest transcription start site. For each gene, only the ACR sequence with the highest enhancer strength was retained.\nextentry
	...
	\ifstab
		...
		\begin{longstab}
			\input{SuppTab4}% TODO: make sure reference is correct
		\end{longstab}
