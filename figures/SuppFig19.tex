\begin{tikzpicture}
	...
	\pgfplotstableread[col sep = tab]{rawData/modisco_motifs_neg_cold_axes.tsv}\axistable
	...
	% get number of bases in motif
	\pgfplotstableread[col sep = tab]{rawData/modisco_TFs_neg_cold_axes.tsv}\axistable
