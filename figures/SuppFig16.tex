\begin{tikzpicture}
	...
	\pgfplotstableread[col sep = tab]{rawData/modisco_motifs_pos_warm_axes.tsv}\axistable
	...
	% get number of bases in motif
	\pgfplotstableread[col sep = tab]{rawData/modisco_TFs_pos_warm_axes.tsv}\axistable
