\begin{tikzpicture}
	...
	\planticon[height = .5cm]{maize} at ($(modisco) + (.6, -.25)$);
	
	% get number of bases in motif
	\pgfplotstableread[col sep = tab]{rawData/modisco_motifs_neg_maize_axes.tsv}\axistable
	...
	% get number of bases in motif
	\pgfplotstableread[col sep = tab]{rawData/modisco_TFs_neg_maize_axes.tsv}\axistable
	
	\pgfplotstablegetelem{0}{xmax}\of\axistable
	\pgfmathsetmacro{\nbases}{int(\pgfplotsretval + 4)}
